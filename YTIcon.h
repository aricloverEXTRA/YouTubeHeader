...
typedef enum {
    ...
    YT_ADD_SMALL = 560,
    YT_BOOKMARK = 565,
    YT_BOOKMARK_BORDER = 566,
    YT_LOCK = 573,
    YT_AUTO_AWESOME = 591,
    YT_LOCATION_ON = 620,
    YT_REELS_COMMENT = 637,
    YT_REELS_COMMENT_FILL = 638,
    YT_CANCEL = 641,
    YT_MY_VIDEOS = 658,
    YT_PREMIUM = 688,
    YT_SCREEN_ROTATION = 701,
    YT_CREATION_TAB_LARGE = 734,
    ...
    YT_TAB_HOME_CAIRO = 1154,
    YT_TAB_SUBSCRIPTIONS_CAIRO = 1155,
    YT_TAB_ACTIVITY_CAIRO = 1156,
    YT_TAB_SHORTS_CAIRO = 1157,
    YT_ACCOUNT_CIRCLE_CAIRO = 1158,
    YT_SEARCH_CAIRO = 1160,
